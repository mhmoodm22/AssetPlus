	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-4">
	    				...
	    				<form action="ValidateAgentLogin.jsp" method="post">
							<p style="color: navy;font-size:1.9em;"><b>AgentId:</b></p> <input autocomplete="off" class="form-control" type="text" name="agentId" placeholder="Enter Your AgentId" required="">
							<br><br>
							<p style="color: navy;font-size:1.9em;"><b>Password:</b></p><input autocomplete="off" class="form-control" type="password" name="agentPassword" placeholder ="Enter Your Password" required="">
							<br><br>	
