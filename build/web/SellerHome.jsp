	    	...
	    	<div class="d-flex justify-content-center align-items-center ">
	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-4">
	    				...
	    				<button type="button" onclick="location.href='HouseDetails.jsp'" class="btn btn-primary btn-lg btn-block">VIEW HOUSES</button>

	    				<br><br>
                                        
                                        <button type="button" onclick="location.href='DeleteHouse.jsp'" class="btn btn-primary btn-lg btn-block">DELETE HOUSES</button>
