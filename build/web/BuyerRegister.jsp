	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-4">
	    				...
	    				<form action="ValidateBuyerRegister.jsp" method="post">
							<p style="color: white;font-size:1.9em;"><b>BuyerName :</b></p><input autocomplete="off" class="form-control" type="text" name="buyerName" placeholder="Enter Your Name.." required="">
							<br><br>
							<p style="color: white;font-size:1.9em;"><b>BuyerContactNumber :</b></p><input autocomplete="off" class="form-control" type="text" name="buyerContact" pattern="[0-9]{10}" placeholder="10 Digit Phone Number.." required="">
							<br><br>
							<p style="color: white;font-size:1.9em;"><b>Password :</b></p><input autocomplete="off" class="form-control" type="password" name="buyerPassword" pattern=".{8,}" placeholder="Eight or More Characters Password.." title="Eight or More Characters"  required="">
							<br><br>
