<%-- 
    Document   : home.jsp
    Created on : May 20, 2023, 6:58:02 PM
    Author     : HUAWEI
--%>
...
<head>
  ...
  <title>Property Management - Find your dream house</title>
        ...
        <nav class="navbar" data-navbar>
          ...
          <div class="navbar-bottom">
            <ul class="navbar-list">
              ...
              <li>
                <a href="index.jsp" class="navbar-link" data-nav-link>Admin and User Accounts</a>
              </li>
      ...
      <section class="hero" id="home">
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <a class="btn" href="mailto:mahmood14a@gmail.com">Make An Enquiry</a>
          ...
          <ul class="service-list">
            ...
            <li>
              <div class="service-card">
                ...
                <a href="BuyerHome.jsp" class="card-link">
        ...
        <div class="container" id="property">
          ...
          <div class="cta-card">
            <div class="card-content">
              ...
              <button class="btn cta-btn" onclick="location.href='index.jsp'">
