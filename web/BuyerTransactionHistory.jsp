	    	        ...
	    	        <%
	    	        	...
	    	        	if(request.getParameter("type")!=null)
	    	        	{
							...
							//{
								...
								if(type.equals("sale"))
								{
									query = "select transaction_id,house.house_id,agent_name,agents.contact_number as agent_contact,city,street_name,apt_no,sale_price,purchase.date from house join purchase on(purchase.house_id = house.house_id) join agents on(house.agent_id=agents.agent_id) where sale_status = \'Y\' and buyer_id = ? ";
								...
								{
                                                                        query = "select transaction_id,house.house_id,agent_name,agents.contact_number as agent_contact,city,street_name,apt_no,sale_price,purchase.date from house join purchase on(purchase.house_id = house.house_id) join agents on(house.agent_id=agents.agent_id) where rent_status = \'Y\' and buyer_id = ? ";
