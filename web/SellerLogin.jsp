	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-4">
	    				...
	    				<form action="ValidateSellerLogin.jsp" method="post">
							<p style="color: black;font-size:1.9em;"><b>Seller Id:</b></p> <input autocomplete="off" class="form-control" type="text" name="sellerId" placeholder="Enter SellerId" required="">
							<br><br>

							<p style="color: black;font-size:1.9em;"><b>Password:</b></p> <input autocomplete="off" class="form-control" type="password" name="sellerPassword"placeholder="Enter Password"   required="">
							<br><br>
